...
import kat from './assets/katalyst.jpg';
const LandingPage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4" style={{
      backgroundImage:`linear-gradient(to right, white , lightpink)`,
    }}>
      <div className="text-center max-w-4xl">
        {/* Header */}
        <div className="mb-8">
          <div className="h-[20vh] w-[30vw] mb-6 mx-auto rounded flex items-center justify-center" style={{
                    backgroundImage: `url(${kat})`,
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          <Link
            ...
            className="w-full sm:w-auto bg-pink-500 text-white px-8 py-4  font-semibold text-lg  transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            Student Login
          </Link>
          <Link
          ...
          <Link
            to="/signup"
            className="w-full sm:w-auto bg-white text-pink-600 px-8 py-4  font-semibold text-lg   transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            Create Account
          </Link>
        </div>
