...
const Login = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${isAdminLogin ? 'from-purple-50 to-white' : 'from-pink-50 to-white'} flex items-center justify-center p-4`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 ${isAdminLogin ? 'focus:ring-purple-500 focus:border-purple-500' : 'focus:ring-pink-500 focus:border-pink-500'} outline-none transition-colors`}
